...
@Component({
  selector: 'app-doch-shgiya-hishuv-premiya',
  templateUrl: './doch-shgiya-hishuv-premiya.component.html',
  styleUrls: ['./doch-shgiya-hishuv-premiya.component.scss']
})
export class DochShgiyaHishuvPremiyaComponent extends BaseReportComponent implements OnInit {
    ...
    reportName: string = "tvr_r_premia_errors";
