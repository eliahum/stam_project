...
@Component({
  selector: 'app-doch-nehiga-ve-rechiz',
  templateUrl: './doch-nehiga-ve-rechiz.component.html',
  styleUrls: ['./doch-nehiga-ve-rechiz.component.scss']
})
export class DochNehigaVeRechizComponent  extends BaseReportComponent implements OnInit {
    ...
    reportName: string = "tvr_r_nehiga_rechiza";
