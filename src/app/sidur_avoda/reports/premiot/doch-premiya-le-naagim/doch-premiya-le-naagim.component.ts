...
@Component({
  selector: 'app-doch-premiya-le-naagim',
  templateUrl: './doch-premiya-le-naagim.component.html',
  styleUrls: ['./doch-premiya-le-naagim.component.scss']
})
export class DochPremiyaLeNaagimComponent extends BaseReportComponent implements OnInit {
